...
use App\Order\Infrastructure\Entrypoint\Http\VoidSentOrderLineController;
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/orders/{orderUuid}/lines/{lineUuid}/void', VoidSentOrderLineController::class);
